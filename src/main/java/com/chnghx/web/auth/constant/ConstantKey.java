package com.chnghx.web.auth.constant;
...
public class ConstantKey {
    ...
    //OAUTH2_URL
    public static final String OAUTH_CLIENT_CALLBACK = "http://cwx.chnghx.com/client/oauth_callback";
    public static final String OAUTH_CLIENT_AUTHORIZE = "http://cwx.chnghx.com/oauth2/authorize";
    public static final String OAUTH_CLIENT_ACCESS_TOKEN = "http://cwx.chnghx.com/oauth2/access_token";
    public static final String OAUTH_CLIENT_GET_RESOURCE = "http://cwx.chnghx.com/oauth2/get_resource";
}
