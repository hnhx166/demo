...
public class ClientController {
    ...
    */
    ...
    public ModelAndView getToken(HttpServletRequest request) throws OAuthProblemException {
        ...
        try {
            ...
            model.addObject("accessToken",  "accessToken: "+accessToken + " resBody: "+resBody);
            model.setViewName("oauth2/token");
