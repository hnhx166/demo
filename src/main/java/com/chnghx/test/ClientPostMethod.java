 ...
 * 
 */
public class ClientPostMethod extends PostMethod {

	public final static String JSONObject = "JSONObject";
	public final static String JSONArray = "JSONArray";
	
	private String systemType = Config.getProperty("api_system_type");
...
//			headers.add(new Header("Connection","close"));
			//调用时间
			headers.add(new Header("rd", System.currentTimeMillis()+""));
			if(!headers.isEmpty()){
...
//			String value = null == str ? "" : StringUtils.trimToEmpty(str.toString());
	 ...
	 * 构造方法begin
	 */
	public ClientPostMethod(String url) {
		super(url);
	}

	public ClientPostMethod(List<Map<String, Object>> parameter) {
		super();
		this.setParameter(parameter);
	}

	public ClientPostMethod(String url, List<Map<String, Object>> parameter) {
		super(url);
		this.setParameter(parameter);
	}

	public ClientPostMethod(Map<String, Object> parameter) {
		super();
		this.setParameter(parameter);
	}

	public ClientPostMethod(String url, Map<String, Object> parameter) {
		super(url);
		this.setParameter(parameter);
	}
