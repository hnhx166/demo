package com.chnghx.core.mybatis.page;
...
public class OracleDialect implements Dialect {
	...
	/**
	 * 备份---- public String getCountSqlString(String sql,Integer begin,Integer size)
	 * { sql = trim(sql); StringBuffer sb = new StringBuffer(sql.length() + 10);
	 * sb.append("SELECT COUNT(1) AS " + RS_COLUMN + " FROM ( "); sb.append(sql);
