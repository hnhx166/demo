package com.chnghx.core.mybatis.base;
...
import com.chnghx.core.mybatis.page.MysqlDialect;
...
/**
 *
 * 用于多数据源，指定Namespace查询,需要通过@Resource注入，按beanName区分
 * 
 */
@SuppressWarnings("unchecked")
public class ThreeBaseMybatisDao extends SqlSessionDaoSupport {

	final static Class<? extends Object> SELF = ThreeBaseMybatisDao.class;
	/** 默认的查询Sql id */
	...
	public Pagination findByPageBySqlId(String namespace, String sqlId, Map<String, Object> params, Integer pageNo,
			Integer pageSize) {
	 ...
	 * @return
	 */
	public List findList(String namespace, String sqlId, Map<String, Object> params, Integer pageNo, Integer pageSize) {
		pageNo = null == pageNo ? 1 : pageNo;
		pageSize = null == pageSize ? 10 : pageSize;
	 ...
	 * @return
	 */
	public List findList(String namespace, Map<String, Object> params, Integer pageNo, Integer pageSize) {
	 ...
	 * @return
	 */
	public Pagination findPage(String namespace, String sqlId, String countId, Map<String, Object> params,
	 ...
	 * @return
	 */
	public Pagination findPage(String namespace, Map<String, Object> params, Integer pageNo, Integer pageSize) {

		return findPage(namespace, DEFAULT_SQL_ID, DEFAULT_COUNT_SQL_ID, params, pageNo, pageSize);
	}
	...
	/*
	 * private Map<String, Object> callProcedureUtils(Map<String, Object> params,
	 * String proName) { this.getSqlSession().selectList(proName, params); return
	 * params; }
	 */
	/**
