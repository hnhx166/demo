...
public class IPUtils {
	...
	public static String getRs(String path, String params, String encoding) {
		...
		try {
			...
			connection.setConnectTimeout(60000);// 设置连接超时时间，单位毫�?

			connection.setReadTimeout(60000);// 设置读取数据超时时间，单位毫�?
	...
	public static void main(String[] args) {
		Map<String, Object> map=getAddress("180.149.132.47");
